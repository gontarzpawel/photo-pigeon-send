...
func TestExifDateWithRealImage(t *testing.T) {
	...
	imagePath := "../uploads/2020/10/17/1741464969934-1e892490.jpg" //testutil.WithExifImagePath
	testutil.CheckTestImageExists(t, imagePath,
		"Test image with EXIF data not found. Place a test image at "+imagePath)
